...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_put_map_image_bonus.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hhammiou <hhammiou@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/22 16:55:46 by hhammiou          #+#    #+#             */
/*   Updated: 2025/01/25 21:49:42 by hhammiou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	put_image(char element, int x_pixel, int y_pixel, t_game_s **vars)
{
	...
	else if (element == 'C')
	{
		...
		pp_image(&vars, x_pixel, y_pixel, "./textures/door/close_door.xpm");
	else if (element == 'M')
	{
		(*vars)->row_m = y_pixel;
		(*vars)->col_m = x_pixel;
